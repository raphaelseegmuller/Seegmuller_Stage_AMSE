...
from libs.useful_fcts import fig_creator_Cdeath_comparator
...
app.layout = html.Div(children=[
    dcc.Graph(
        id='graph',
        figure=fig_creator_Cdeath_comparator(["France"], 'Non', 'Non', days_around)
    ),
...
def update_graph(name_list, normalize, normalize2):
    return fig_creator_Cdeath_comparator(name_list, normalize, normalize2, days_around)
