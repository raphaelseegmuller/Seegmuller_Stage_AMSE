...
from libs.useful_fcts import fig_creator_CC
...
app.layout = html.Div(children=[
    dcc.Graph(
        id='graph',
        figure=fig_creator_CC(["France"], 'Non')
    ),
...
@app.callback(
    ...
    [Input('Country_choice', 'value'),
     Input('Normalize_choice', 'value')])
def update_graph(name_list, normalize):
    return fig_creator_CC(name_list, normalize)
